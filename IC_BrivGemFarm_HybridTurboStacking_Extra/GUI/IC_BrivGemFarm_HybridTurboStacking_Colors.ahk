Class IC_BrivGemFarm_HybridTurboStacking_Colors
{
    ...
    NewColoredLV(guiName, controlID)
    {
        ...
        if (SH_VersionHelper.IsVersionNewer("1.1.37.02", A_AhkVersion))
        {
            ...
            instance := new IC_BrivGemFarm_HybridTurboStacking_Colors.LV_Colors_Fixed(hwnd, true)
        return instance
    }
