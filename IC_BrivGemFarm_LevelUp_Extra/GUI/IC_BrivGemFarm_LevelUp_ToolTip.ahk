Class IC_BrivGemFarm_LevelUp_ToolTip
{
    ...
    AddToolTips()
    {
        ...
        GUIFunctions.AddToolTip("BGFLU_Combo_BrivMinLevelStacking", "Minimum Briv level to reach before stacking. After stacking is done, leveling will resume up to MaxLevel")
        GUIFunctions.AddToolTip("BGFLU_BrivMinLevelStackingText", "Minimum Briv level to reach before stacking. After stacking is done, leveling will resume up to MaxLevel")
        ...
        GUIFunctions.AddToolTip("BGFLU_ThelloraRushWaitText", "Minimum area reached (highest, not current) before stopping to wait for Thellora's Rush to activate.")
