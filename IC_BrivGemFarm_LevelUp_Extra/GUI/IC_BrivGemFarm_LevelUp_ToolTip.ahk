Class IC_BrivGemFarm_LevelUp_ToolTip
{
    ...
    AddToolTips()
    {
        ...
        GUIFunctions.AddToolTip("BGFLU_ClickDamageMatchArea", "Click damage level will match the number sligthly above the highest area reached in the current run.")
        GUIFunctions.AddToolTip("BGFLU_ClickDamageMatchAreaText", "Click damage level will match the number sligthly above the highest area reached in the current run.")
